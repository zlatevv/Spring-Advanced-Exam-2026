  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<Layout><RequireRole roles={['CURATOR', 'ADMIN']}><RequestManagementPage /></RequireRole></Layout>}
      />
      <Route
        path="/manage/manuscripts"
        element={<Layout><RequireRole roles={['CURATOR', 'ADMIN']}><ManuscriptManagementPage /></RequireRole></Layout>}
      />
      <Route
        path="/manage/reservations"
        element={<Layout><RequireRole roles={['CURATOR', 'ADMIN']}><ReservationsOverviewPage /></RequireRole></Layout>}
      />
      <Route
        path="/manage/digitization"
        element={<Layout><RequireRole roles={['CURATOR', 'ADMIN']}><DigitizationDashboardPage /></RequireRole></Layout>}
      />
      <Route
        path="/admin/users"
