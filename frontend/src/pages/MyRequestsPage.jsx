        ...
        <div className="page">
            ...
            {loading ? (
                ...
                <EmptyState title="No requests yet"
                            hint={<>Browse the <Link to="/catalog">catalog</Link> and request access to a
                                manuscript.</>}/>
            ) : (
                                    ...
                                    {r.status === 'APPROVED' ? (
                                        <div style={{display: 'flex', gap: '0.4rem'}}>
                                            <input
                                                ...
                                                onChange={(e) => setSlots({
                                                    ...slots,
                                                    [r.id]: {...slots[r.id], date: e.target.value}
                                                })}
                                                style={{
                                                    padding: '0.35rem',
                                                    borderRadius: 3,
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setSlots({
                                                    ...slots,
                                                    [r.id]: {...slots[r.id], time: e.target.value}
                                                })}
                                                style={{
                                                    padding: '0.35rem',
                                                    borderRadius: 3,
                                            ...
                                            <button className="btn btn-primary btn-sm"
                                                    onClick={() => onReserve(r.id)}>Reserve
                                            </button>
                                        </div>
                                    ) : (
