    ...
    <div className="page">
      ...
      <form onSubmit={onSearch} style={{ display: 'flex', gap: '0.8rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
        <input
          ...
          style={{ flex: '1 1 260px', padding: '0.7rem 0.9rem', borderRadius: 3, border: '1px solid var(--parchment-line)', background: '#f4efe0' }}
        />
        <select
          value={era}
          onChange={(e) => setEra(e.target.value)}
          style={{ padding: '0.7rem 0.9rem', borderRadius: 3, border: '1px solid var(--parchment-line)', background: '#f4efe0' }}
        >
